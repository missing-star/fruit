new Vue({
    ...
    computed:{
        totalMoney:function() {
            console.log(parseFloat(0)+parseFloat(1.523));
            return this.calculateGoodsList.reduce(function(pre,next) {
                console.log('pre='+parseFloat(pre.totalPrice) + ',next='+parseFloat(next.totalPrice));
                return (parseFloat(pre.totalPrice) + parseFloat(next.totalPrice));
            },{totalPrice:0});
        }
    },
    filters: {
