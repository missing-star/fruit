new Vue({
    ...
    methods: {
        ...
        takePhoto: function () {
            ...
            formData.append('file', vm.dataURLtoFile(base64Data));
            formData.append('shopCode', vm.shopCode);
            // http://xq.kzxzcc.cn/index.php?r=api/save-avatar admin/uploadManager/photoView
            axios.post('http://xq.kzxzcc.cn/index.php?r=api/save-avatar', formData, {
                headers: {
    ...
    created: function () {
        ...
        // vm.getWeight();
        // vm.login();
        vm.getUserMedia({video : {width: 480, height: 320}}, vm.success, vm.error);
        vm.getCategoryList();
    }
});