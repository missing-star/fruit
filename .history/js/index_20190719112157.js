new Vue({
    ...
    methods: {
        ...
        getText: function () {
            var vm = this;
            axios.get('/rpcShop/queryOrderList', this.stringifyParams({
                shopCode: vm.shopCode,
                isVoice: 0
            })).then(function (data) {
                vm.playAudio(encodeURI(encodeURI(text)));
            }).catch(function (err) {
                vm.log(err);
            })
        },
        ...
        playAudio: function (text) {
            ...
            // var accessToken = '24.9d9167d9c4474454c1009197ee05a3d3.2592000.1566033758.282335-16837413';
        },
        /**
         * 获取商家产品
         */
