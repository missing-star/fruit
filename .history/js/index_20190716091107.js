new Vue({
    ...
    methods: {
         ...
         * @param {number} currentOrder 
         */
        getOrderDetailOffline: function (onlineCurrentIndex, currentOrder) {
         ...
         */
        login:function() {
            axios.post('rpcShop/querOneShop',{shopCode:'HP8097021061',shopPwd:'123'}).then(function() {
    ...
    created: function () {
        axios.defaults.baseURL = 'http://52.83.136.234';
        var vm = this;
        vm.getCurrentTime();
        setInterval(function () {
            vm.getCurrentTime();
