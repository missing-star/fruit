new Vue({
    ...
    methods: {
        ...
        getText: function () {
            var vm = this;
            axios.post('/rpcShop/queryOrderList', this.stringifyParams({
                shopCode: vm.shopCode,
                isVoice: 0
            })).then(function (data) {
                vm.playAudio(encodeURI(encodeURI(data)));
            }).catch(function (err) {
                vm.log(err);
            })
        },
        ...
        playAudio: function (text) {
            ...
            var accessToken = "24.d3b2f8d6548201ecafb3ca9e98d578cb.2592000.1566099257.282335-16585060";
            var url = 'https://tsn.baidu.com/text2audio?lan=zh&ctp=1&cuid=2C-4D-54-59-59-20&tok=' + accessToken +
                '&tex=' + text;
            ...
            // var vm = this;
            // vm.getToken(function (accessToken) {
            //     accessToken = "24.d3b2f8d6548201ecafb3ca9e98d578cb.2592000.1566099257.282335-16585060";
            //     var url = 'https://tsn.baidu.com/text2audio?lan=zh&ctp=1&cuid=2C-4D-54-59-59-20&tok=' + accessToken +
            //         '&tex=' + text;
            //     var audio = document.createElement("audio")
            //     audio.src = url;
